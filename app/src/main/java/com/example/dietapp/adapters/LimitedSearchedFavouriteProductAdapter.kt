...
class LimitedSearchedFavouriteProductAdapter(context: Context, private var names: MutableList<String>, private var proteins: MutableList<Int>, private var fats: MutableList<Int>, private var carbs: MutableList<Int>, private var calories: MutableList<Int>):
    RecyclerView.Adapter<LimitedSearchedFavouriteProductAdapter.ViewHolder>()
{
    val context = context
    ...
    fun addItem(position: Int) {
        val intent = Intent(context, SubmitFavouriteProductActivity::class.java)
